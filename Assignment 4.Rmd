...
Using the data collected in the HUDK4050 entrance survey use K-means to cluster the students first according location (lat/long) and then according to their answers to the questions so that each student belongs to two clusters.
